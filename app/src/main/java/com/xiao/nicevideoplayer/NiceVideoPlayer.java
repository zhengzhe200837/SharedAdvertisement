...
public class NiceVideoPlayer extends FrameLayout
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        android.util.Log.d("zz", "--zz + NiceVideoPlayer + onSurfaceTextureAvailable() + width = " + width + " height = " + height);
...
//            zhengzhe end
    ...
    private IMediaPlayer.OnInfoListener mOnInfoListener
        ...
        public boolean onInfo(IMediaPlayer mp, int what, int extra) {
            android.util.Log.d("zz", "--zz + NiceVideoPlayer + onInfo() + what = " + what);
    ...
    private IMediaPlayer.OnBufferingUpdateListener mOnBufferingUpdateListener
        ...
        public void onBufferingUpdate(IMediaPlayer mp, int percent) {
            android.util.Log.d("zz", "--zz + percent = " + mUrl.startsWith("http"));
